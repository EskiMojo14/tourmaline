...
describe("ThreadView", () => {
  ...
  it("renders loading state initially", () => {
    ...
    renderWithProviders(
      <ThreadView threadId={threadId} onBack={mockOnBack} />,
      {
        preloadedState,
      },
    );
  ...
  it("renders error state", () => {
    ...
    expect(
      screen.getByText("Error: Failed to load thread"),
    ).toBeInTheDocument();
  });
  ...
  it("renders thread with posts", () => {
    ...
    expect(
      screen.getByText("This is a test thread content."),
    ).toBeInTheDocument();
  ...
  it("shows login prompt for unauthenticated users", () => {
    ...
    expect(
      screen.getByText("You need to be logged in to reply"),
    ).toBeInTheDocument();
  ...
  it("shows reply form for authenticated users", () => {
    ...
    expect(
      screen.getByPlaceholderText(
        "What are your thoughts? Be respectful and constructive...",
      ),
    ).toBeInTheDocument();
